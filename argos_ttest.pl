...
#  ' --- 1 - 5 -------------------
#  Sample (1,vltBattery,FP2)  #ARGOSFIELD 9
#  Sample (1,degPTemp,FP2)	#ARGOSFIELD 10
#  Sample (1,mtrDepthKTE,FP2)	#ARGOSFIELD 11
#  Sample (1,degLakeTemp,FP2)	#ARGOSFIELD 12
#  Sample (1,psiBoxRTO,FP2)	#ARGOSFIELD 13
#  ' --- 6 - 10 ------------------
#  Sample (1,mvHPhoneRange,FP2)	#ARGOSFIELD 14
#  Sample (1,fft1Hz,FP2)	#ARGOSFIELD 15
#  Sample (1,fft3Hz,FP2)	#ARGOSFIELD 16
#  Sample (1,fft5Hz,FP2)	#ARGOSFIELD 17
#  Sample (1,fft10Hz,FP2)	#ARGOSFIELD 18
#  ' --- 11 - 15 ----------------
#  Sample (1,fft30Hz,FP2)	#ARGOSFIELD 19
#  Sample (1,fft100Hz,FP2)	#ARGOSFIELD 20
#  Sample (1,fft300Hz,FP2)	#ARGOSFIELD 21
#  Sample (1,nIntervalNo,FP2)	#ARGOSFIELD 22
#  Sample (1,fCheckSum,FP2) 	#ARGOSFIELD 23
#EndTable
...
use constant FLD_DATA_END   => 23; ######### LAST index of FP2-encoded data fields
# FP2-Encoded data fields: 
use constant FLD_DEPTH_KTE     =>  9;   # Lake Depth (m) was 11
use constant FLD_LAKE_TEMP     => 10;   # Lake Temp (Deg C) was 12
use constant FLD_PANEL_TEMP    => 11;   # Logger Panel Temp (Deg C) was 10
use constant FLD_BOX_PRESSURE  => 12;   # Box Pressure (PSI) was 13
...
use constant FLD_BATTERY       => 21;   # Battery (volts) was 9
use constant FLD_INTERVAL_NO   => 22;   # index of 15 minute sample interval into UTC day 
use constant FLD_CHECKSUM      => 23;   # Checksum (see CheckCheckSum sub for notes on how it's calculated)
#:
#
...
#	$DepthRTO = ($DecodedRecord[FLD_DEPTH_RTO]-$DecodedRecord[FLD_BOX_PRESSURE]) * PSI_TO_DEPTH;
        print STDOUT $ThisTimeStamp . "," . 
                    sprintf("%0.3f",$DecodedRecord[9]) . "," . 
                    sprintf("%0.3f",$DecodedRecord[10]) . "," . 
                    sprintf("%0.3f",$DecodedRecord[11]) . "," . 
                    sprintf("%0.3f",$DecodedRecord[12]) . "," . 
                    sprintf("%0.3f",$DecodedRecord[13]) . "," . 
                    sprintf("%0.3f",$DecodedRecord[14]) . "," . 
                    sprintf("%0.3f",$DecodedRecord[15]) . "," . 
                    sprintf("%0.3f",$DecodedRecord[16]) . "," . 
                    sprintf("%0.3f",$DecodedRecord[17]) . "," . 
                    sprintf("%0.3f",$DecodedRecord[18]) . "," . 
                    sprintf("%0.3f",$DecodedRecord[19]) . "," . 
                    sprintf("%0.3f",$DecodedRecord[20]) . "," . 
                    sprintf("%0.3f",$DecodedRecord[21]) . "," . 
                    sprintf("%0.3f",$DecodedRecord[22]/10.) . "," . 
                    sprintf("%0.3f",$DecodedRecord[23]) . "\n"; 
