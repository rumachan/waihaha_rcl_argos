...
#  ' --- 1 - 5 -------------------
#  Sample (1,vltBattery,FP2)    #ARGOS DATA FIELD 9
#  Sample (1,degPTemp,FP2)	#ARGOS DATA FIELD 10
#  Sample (1,mtrDepthKTE,FP2)	#ARGOS DATA FIELD 11
#  Sample (1,degLakeTemp,FP2)	#ARGOS DATA FIELD 12
#  Sample (1,psiBoxRTO,FP2)	#ARGOS DATA FIELD 13
#  ' --- 6 - 10 ------------------
#  Sample (1,mvHPhoneRange,FP2)	#ARGOS DATA FIELD 14
#  Sample (1,fft1Hz,FP2)	#ARGOS DATA FIELD 15
#  Sample (1,fft3Hz,FP2)	#ARGOS DATA FIELD 16
#  Sample (1,fft5Hz,FP2)	#ARGOS DATA FIELD 17
#  Sample (1,fft10Hz,FP2)	#ARGOS DATA FIELD 18
#  ' --- 11 - 15 -----------------
#  Sample (1,fft30Hz,FP2)	#ARGOS DATA FIELD 19
#  Sample (1,fft100Hz,FP2)	#ARGOS DATA FIELD 20
#  Sample (1,fft300Hz,FP2)	#ARGOS DATA FIELD 21
#  Sample (1,nIntervalNo,FP2)	#ARGOS DATA FIELD 22
#  Sample (1,fCheckSum,FP2) 	#ARGOS DATA FIELD 23
#EndTable
...
use constant FLD_DEPTH_KTE     =>  9;   # Lake Depth (m) #was field 9
use constant FLD_LAKE_TEMP     => 10;   # Lake Temp (Deg C) #was field 10
use constant FLD_PANEL_TEMP    => 11;   # Logger Panel Temp (Deg C) #was field 11
use constant FLD_BOX_PRESSURE  => 12;   # Box Pressure (PSI) #was field 12
...
use constant FLD_BATTERY       => 20;   # Battery (volts) # was field 20
use constant FLD_INTERVAL_NO   => 21;   # index of 15 minute sample interval into UTC day. #Was field 21
use constant FLD_CHECKSUM      => 22;   # Checksum (see CheckCheckSum sub for notes on how it's calculated). #Was field 22.
#:
#
